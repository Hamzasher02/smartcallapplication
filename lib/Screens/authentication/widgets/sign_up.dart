...
import 'package:inventory_management_system/Widgets/rounded_icon_button.dart';
          ...
          child: Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                SizedBox(
                  width: 400,
                  child: DropdownlabelLarge<String>(
                    value: exam,
                    items: <String>[
                      '1',
                      '2',
...
class DropdownlabelLarge<T> extends StatelessWidget {
  final T value;
  final List<DropdownMenuItem<T>> items;
  final ValueChanged<T?> onChanged;

  const DropdownlabelLarge({
    Key? key,
    required this.value,
    required this.items,
