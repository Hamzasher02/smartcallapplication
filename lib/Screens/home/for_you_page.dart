...
import 'package:inventory_management_system/Screens/call/agora/screen_video_call.dart';
import 'package:inventory_management_system/Screens/chat/chat_screen.dart';
import 'package:inventory_management_system/Util/app_url.dart';
import 'package:inventory_management_system/Widgets/country_to_flag.dart';
import 'package:inventory_management_system/Widgets/custom_card_tile.dart';
import 'package:inventory_management_system/db/entity/app_user.dart';
import 'package:inventory_management_system/db/entity/chat.dart';
import 'package:inventory_management_system/db/entity/fvrt.dart';
import 'package:inventory_management_system/db/entity/message.dart';
import 'package:inventory_management_system/db/entity/sentmessage.dart';
import 'package:inventory_management_system/db/entity/utils.dart';
import 'package:inventory_management_system/db/remote/firebase_database_source.dart';
...
class _ForYouPageState extends State<ForYouPage> {
  ...
  showUserView(BuildContext context, String id, img, name, country, date, age,
      gender, view, like, myid, myuser, otherId, index, temp1) {
    int views;
    print(view);
                            ...
                            Expanded(
                              ...
                              child: Row(
                                ...
                                children: [
                                  ...
                                  // ZegoSendCallInvitationlabelLarge(
                                  //     isVideoCall: true,
...
//                                     },
//                                     child: CircleAvatar(
//                                       colorScheme.background: Colors.lightBlueAccent.withOpacity(0.7),
//                                       radius: 30,
//                                       child: const Icon(
//                                         Icons.chat,
//                                         size: 30,
...
//   Widget build(BuildContext context) {
//     return Scaffold(
//       colorScheme.background: Colors.grey,
//       body: RefreshIndicator(
//         color: Theme.of(context).colorScheme.onPrimary,
//         triggerMode: RefreshIndicatorTriggerMode.onEdge,
//         onRefresh: _refresh,
...
//         maincolorScheme.background: Colors.purple,
//         cornerRadius: 10.0,
...
//           colorScheme.background: Colors.cyan,
...
//           colorScheme.background: Colors.amber,
