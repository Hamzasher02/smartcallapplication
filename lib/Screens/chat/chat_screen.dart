...
import 'package:inventory_management_system/Screens/chat/widget/chat_top_bar.dart';
...
import '../call/agora/screen_video_call.dart';
...
class _MessageScreenState extends State<MessageScreen> {
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        actions: const [
          ...
          //     // labelLargeSize: Size(20, 20),
          //   labelLargeSize: const Size(50, 40),
          //     isVideoCall: false,
              ...
              builder: (context, snapshot) {
                ...
                if (snapshot.data != null && snapshot.data!.docs.isNotEmpty) {
                  checkAndUpdateLastMessageSeen(messages.first,
                      snapshot.data!.docs[0].id, widget.myUserId);
                  // print('hoo');
  ...
  void sendMessage(String myUserId, String msg, String type) {
    ...
    Message message = Message(
        DateTime.now().millisecondsSinceEpoch, false, myUserId, msg, type);
